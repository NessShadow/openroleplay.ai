...
export const NOVID_API_URL = "https://api.runpod.ai/v2/il4lakeb13vrr7/openai/v1";
...
export const modelData = [
  ...
  // },
  {
    value: "tanamettpk/TC-Novid-v3",
    description: "Uncensored, Novid v3 by Techcast",
    crystalPrice: 1,
    isNSFW: true,
  },
  // {
...
export const imageModelData = [
  ...
  // {
  //   value: "daun-io/RoleplayChat.ai-animagine-v3",
